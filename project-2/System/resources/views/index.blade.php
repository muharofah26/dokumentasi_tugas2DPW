...
<html lang="en">
   <head>
      ...
      <!-- owl carousel style -->
      <link rel="stylesheet" type="text/css" href="{{ url('public') }}/assets/https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.0.0-beta.2.4/assets/owl.carousel.min.css" />
      <!-- bootstrap css -->
      ...
      <link rel="stylesheet" href="{{ url('public') }}/assets/https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
      <!-- owl stylesheets --> 
      ...
      <link rel="stylesheet" href="{{ url('public') }}/assets/https://cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.css" media="screen">
   </head>
   <body>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="taital_main">
                                 <h4 class="banner_taital"><span class="font_size_90">10%</span> Discount Magic Shop</h4>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="taital_main">
                                 <h4 class="banner_taital"><span class="font_size_90">10%</span> Discount Online Shop</h4>
                                 <p class="banner_text"></p>
                                 <div class="book_bt"><a href="#">Shop Now</a></div>
                              </div>
                           </div>
         ...
         <div class="category_section">
            <div class="row">
               <div class="col-lg-2 col-sm-12">
                  <h1 class="category_text">Kategori</h1>
               </div>
               <div class="col-lg-10 col-sm-12 main">
                  ...
                  <div class="col">
                     <div class="box_main">
                        ...
                        <h4 class="fashion_text">Pakaian</h4>
                     </div>
                  </div>
                  <div class="col">
                     <div class="box_main">
                        <div class="icon_3"></div>
                        <h4 class="fashion_text">Jam</h4>
                     </div>
                  </div>
                  <div class="col">
                     <div class="box_main">
                        <div class="icon_4"></div>
                        <h4 class="fashion_text">Aksesoris</h4>
                     </div>
                  </div>
                  <div class="col">
                     <div class="box_main">
                        <div class="icon_5"></div>
                        <h4 class="fashion_text">Sweater & Jacket</h4>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="information_main">
                     ...
                     <p class="call_text"><a href="#">0895704204619</a></p>
                     <p class="call_text"><a href="#">muharofah7@gmail.com</a></p>
